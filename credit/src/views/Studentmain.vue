<template>
			...
			<div class="home_userinfoContainer">
				<el-dropdown>
					<span class="el-dropdown-link home_userinfo">
						{{student.name}}<i class="el-icon-arrow-down el-icon--right home_userinfo"></i>
					</span>
  ...
  <el-container>
      <el-aside class="home_aside" width="200px">
        <el-menu router>
          <el-menu-item index="/myrecord" :class="$route.path=='/myrecord'?'is-active':''">
			 <!-- 地址栏访问时同样选中 -->
            <i class="el-icon-menu"></i>
            <span slot="title">我的档案</span>
          </el-menu-item>
          <el-menu-item index="/managerpermission" :class="$route.path=='/managerpermission'?'is-active':''">
            <i class="el-icon-document"></i>
            <span slot="title">授权管理</span>
          </el-menu-item>
          <el-menu-item index="/studentCenter" :class="$route.path=='/studentCenter'?'is-active':''">
